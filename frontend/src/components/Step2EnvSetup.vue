        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              ...
              <div v-if="useCustomRounds" class="rounds-content custom">
              ...
              <div v-else class="rounds-content auto">
...
/* Slider Content */
.rounds-content {
  /* Removed animation to prevent transition conflicts */
}
...
/* Removed conflicting animation and fade transition classes */
